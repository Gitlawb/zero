...
var descriptors = []Descriptor{
	...
	openAICompat("fireworks", "Fireworks AI", "https://api.fireworks.ai/inference/v1", "accounts/fireworks/models/deepseek-v3-0324", []string{"FIREWORKS_API_KEY"}, "fireworks-ai"),
