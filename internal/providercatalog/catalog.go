...
var descriptors = []Descriptor{
	...
	anthropicCompat("minimax", "MiniMax", "https://api.minimax.io/anthropic/v1", "MiniMax-M3", []string{"MINIMAX_API_KEY"}, "mini-max", "mini_max"),
	anthropicCompat("minimaxi-cn", "MiniMax CN", "https://api.minimaxi.com/anthropic/v1", "MiniMax-M3", []string{"MINIMAXI_API_KEY"}, "minimax cn", "minimax-cn"),
