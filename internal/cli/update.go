...
Flags:
      ...
      --repo <owner/repo>     Repository to use when no endpoint is provided (--check and --apply)
      --endpoint <url|repo>   Release API URL or owner/repo slug to use (--check and --apply)
