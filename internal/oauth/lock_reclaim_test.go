...
func TestReclaimStaleLock(t *testing.T) {
	...
	if !reclaimStaleLock(lockPath, "tok-a", fileLockStaleAfter) {
	...
	if reclaimStaleLock(lockPath, "tok-b", fileLockStaleAfter) {
	...
	if reclaimStaleLock(lockPath, "tok-c", fileLockStaleAfter) {
