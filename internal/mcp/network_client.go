...
// maxSSEEventBytes bounds a single SSE line/event. It accommodates an accepted
// 10 MiB image payload in base64 (~13.98 MiB) plus JSON-RPC envelope, metadata,
// and SSE framing overhead.
