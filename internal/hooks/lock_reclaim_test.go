...
func TestReclaimStaleLock(t *testing.T) {
	...
	if !reclaimStaleLock(lockPath, "tok-a", auditLockStaleAfter) {
	...
	if reclaimStaleLock(lockPath, "tok-b", auditLockStaleAfter) {
	...
	if reclaimStaleLock(lockPath, "tok-c", auditLockStaleAfter) {
